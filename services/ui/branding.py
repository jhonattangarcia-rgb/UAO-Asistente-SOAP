"""Brand constants for the presentation layer.

Pure data (no Streamlit, no business logic): the strings shown in the
app header and badge. Kept separate from styles and components so brand
copy can change without touching CSS or render logic.
"""
